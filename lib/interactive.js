...
var interactive = module.exports = cmd => {
    ...
    vorpal
        ...
        .action(function (args, cb) {
            ...
            return cmd
                ...
                .then(() => this.log(`Proxy speed is limited to ${args.speed} kb/s`.green))
                .catch(e => this.log(e))
                .then(cb);
        });
    ...
    vorpal
        ...
        .action(function (args, cb) {
            ...
            return cmd
                .resetProxySpeed()
                .then(() => this.log("Proxy speed is unlimited".green))
                .catch(e => this.log(e))
                .then(cb);
        });
    ...
    vorpal
        ...
        .action(function (args, cb) {
            ...
            return cmd
                .enableProxyCache()
                .then(() => this.log("Proxy cache is enabled".green))
                .catch(e => this.log(e))
                .then(cb);
        });
    ...
    vorpal
        ...
        .action(function (args, cb) {
            ...
            return cmd
                .disableProxyCache()
                .then(() => this.log("Proxy cache is disabled".green))
                .catch(e => this.log(e))
                .then(cb);
        });
